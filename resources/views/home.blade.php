...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">Hw<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="#portfolio">AddComplain</a></li>
          <li><a class="nav-link scrollto" href="#team">HostedBy</a></li>
          <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
          <li class="dropdown"><a href="#"><span>Signup</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><span>SIGNUP</span> <i class="bi bi-chevron-right"></i>
                <ul>
                  <li class="dropdown"><a href="/signup"><i class="bi bi-chevron-right"></i></a>CUSTOMER</li>
                  <li class="dropdown"><a href="/shopeup"><i class="bi bi-chevron-right"></i></a>SHOPKEEPER</li>
                </ul>
              </li>
            </ul>
          </li>
          <li class="dropdown"><a href="#"><span>Login</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><span>LOGINS</span> <i class="bi bi-chevron-right"></i>
                <ul>
                  <li class="dropdown"><a href="/login"><i class="bi bi-chevron-right"></i></a>CUSTOMER</li>
                  <li class="dropdown"><a href="/shoplogin"><i class="bi bi-chevron-right"></i></a>SHOPKEEPER</li>
                </ul>
              </li>
            </ul>
          </li>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h2>Go And Get Started <span></span></h2>
          <h2></h2>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            ...
            ReadyAssist is India's leading technology backed roadside assistance and vehicle lifecycle management company, providing 24/7 real-time breakdown and on-spot repair service across 16650+ pin codes covering 700+ districts in India.  Powered by a deep tech platform and driven by a Pan-India network of more than 5000+ skilled and groomed mechanics, we ensure Reliability & Quality without compromising on Speed.  Currently, we provide 24hrs roadside assistance for both Bikes & Cars anytime at any nook & corner of the country to our Subscribed Customers.  We also provide on demand support to customers in cities like Bangalore, Hyderabad, Mumbai, Pune, Delhi, Gurgaon, Chennai and more.
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <a href="/complaints" data-filter="*" class="filter-active">Complaints
              <li data-filter=".filter-app">car</li>
              <li data-filter=".filter-card">Bike</li>
              <li data-filter=".filter-web">Activa</li>
            </ul>
          </div>
        </div>
