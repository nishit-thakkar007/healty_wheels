    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="/view">Active user</a></li>
          <li><a class="nav-link scrollto" href="/imgview">Imgview</a></li>
          <li><a class="nav-link scrollto " href="view1">Active shopkeeper</a></li>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h2>Hello welcome to HEALTY WHEELS<span></span></h2>
        </div>
      </div>
  ...
  <main id="main">
    ...
    <section id="features" class="features">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="image col-lg-6" style='background-image: url("assets/img/features.jfif");' data-aos="fade-right"></div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li><a href="/complaints" data-filter="*" class="filter-active">Complaints<></li>
