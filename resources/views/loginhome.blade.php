...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{route('mycomp')}}">Mycomplain</a></li>
          <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
          </nav><!-- .navbar -->

      <a href="{{url('myprofile/'.$myData->id)}}" class="get-started-btn scrollto">{{$myData->name}}</a>
      <a href="/logout1" class="get-started-btn scrollto">logout</a>
    </div>
  </header><!-- End Header -->
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h2>Hello {{$myData->name}} welcome to HEALTY WHEELS<span></span></h2>
        </div>
      </div>
  ...
  <main id="main">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <a href="/complaints" data-filter="*" class="filter-active">Complaints</a>
    ...
    </section><!-- End my complains Section -->
