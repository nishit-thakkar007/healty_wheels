    ...
    <div class="row bootstrap snippets bootdeys">
        <div class="col-md-5 col-md-offset-3">
            <div class="text-center logo-alt-box">
                <a href="index.html" class="logo" style="float: none;color: #3ec845;font-size: 24px;letter-spacing: .06em;line-height: 46px;">
                    <span>Biexam.com</span>
                </a>
                <h5 class="text-muted m-t-0" style="font-size: 12px;">Crea y comparte exámenes en linea</h5>
            </div>
            <div class="m-t-30 card-box" style="margin-bottom: 20px;background-clip: padding-box;-moz-border-radius: 5px;border-radius: 5px;-webkit-border-radius: 5px;padding: 20px;background-color: #ffffff;box-shadow: 0 8px 42px 0 rgba(0, 0, 0, 0.08);">
                ...
                <div class="panel-body text-center">
            		...
            		<p class="text-muted font-13 m-t-20" style="color: #9a9da0"> 
                        A email has been send to <b></b>. Please check for an email from company and click on the included link to reset your password.  
                    </p>
                </div>
            </div>
        </div>
